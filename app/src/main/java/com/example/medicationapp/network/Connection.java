    ...
    public void sendRequest(Request request) {
        firebaseDatabase.getReference(Common.Request)
                ...
                .addOnSuccessListener(unused ->
                        Toast.makeText(context, context.getString(R.string.request_has_been_sent), Toast.LENGTH_SHORT).show()).addOnFailureListener(e -> Log.d("FAILURE", "failed : "+ e.getMessage()));
